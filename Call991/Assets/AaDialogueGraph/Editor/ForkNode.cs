...
namespace AaDialogueGraph.Editor
{
    public class ForkNode : AaNode
    {
        public void Set(ForkNodeData data, string guid)
        {
            ...
            {
                CreateForkExitElement(new ForkCaseData(new CaseData(), System.Guid.NewGuid().ToString()));
            });
            ...
            {
                CreateForkExitElement(new ForkCaseData(forkCase, forkCase.ForkExitName));
            }
        }

        private void CreateForkExitElement(ForkCaseData data)
        {
            var exitContainer = new ForkExitElement();
            exitContainer.Set(this, contentContainer.Remove, data.Words, data.Ends, data.Counts, data.ForkExitName);
    ...
    public class ForkExitElement : VisualElement
    {
            ...
            List<EndData> endData, List<CountData> countData, string exitGuid)
        {
            ...
            caseElement.Set(caseFoldout, wordData, endData, countData);

...
{
    public class ImagePhraseNode : AaNode
    {
        ...
        public void Set(ImagePhraseNodeData data, List<string> languages, SoundLists soundLists, string guid)
        {
            ...
            contentFolder.AddToClassList("aa-ImagePhraseNode_extension-container");
            ...
            var personVisual = new ImagePersonVisual();
            personVisual.Set(data.ImagePersonVisualData, val =>
            {
